...
/*-----USART register definition-----*/
    ...
    #define DMA1_HIFCR REG32(DMA1_BASE + DMA_HIFCR_OFFSET)
        #define DMA1_STREAM0_SxCR REG32(DMA1_BASE + DMA_STREAM0_OFFSET + DMA_SxCR_OFFSET)
        #define DMA1_STREAM0_SxNDTR REG32(DMA1_BASE + DMA_STREAM0_OFFSET + DMA_SxNDTR_OFFSET)
        #define DMA1_STREAM0_SxPAR REG32(DMA1_BASE + DMA_STREAM0_OFFSET + DMA_SxPAR_OFFSET)
        #define DMA1_STREAM0_SxM0AR REG32(DMA1_BASE + DMA_STREAM0_OFFSET + DMA_SxM0AR_OFFSET)
        #define DMA1_STREAM0_SxM1AR REG32(DMA1_BASE + DMA_STREAM0_OFFSET + DMA_SxM1AR_OFFSET)
        #define DMA1_STREAM0_SxFCR REG32(DMA1_BASE + DMA_STREAM0_OFFSET + DMA_SxFCR_OFFSET)
        #define DMA1_STREAM1_SxCR REG32(DMA1_BASE + DMA_STREAM1_OFFSET + DMA_SxCR_OFFSET)
        #define DMA1_STREAM1_SxNDTR REG32(DMA1_BASE + DMA_STREAM1_OFFSET + DMA_SxNDTR_OFFSET)
        #define DMA1_STREAM1_SxPAR REG32(DMA1_BASE + DMA_STREAM1_OFFSET + DMA_SxPAR_OFFSET)
        #define DMA1_STREAM1_SxM0AR REG32(DMA1_BASE + DMA_STREAM1_OFFSET + DMA_SxM0AR_OFFSET)
        #define DMA1_STREAM1_SxM1AR REG32(DMA1_BASE + DMA_STREAM1_OFFSET + DMA_SxM1AR_OFFSET)
        #define DMA1_STREAM1_SxFCR REG32(DMA1_BASE + DMA_STREAM1_OFFSET + DMA_SxFCR_OFFSET)
        #define DMA1_STREAM2_SxCR REG32(DMA1_BASE + DMA_STREAM2_OFFSET + DMA_SxCR_OFFSET)
        #define DMA1_STREAM2_SxNDTR REG32(DMA1_BASE + DMA_STREAM2_OFFSET + DMA_SxNDTR_OFFSET)
        #define DMA1_STREAM2_SxPAR REG32(DMA1_BASE + DMA_STREAM2_OFFSET + DMA_SxPAR_OFFSET)
        #define DMA1_STREAM2_SxM0AR REG32(DMA1_BASE + DMA_STREAM2_OFFSET + DMA_SxM0AR_OFFSET)
        #define DMA1_STREAM2_SxM1AR REG32(DMA1_BASE + DMA_STREAM2_OFFSET + DMA_SxM1AR_OFFSET)
        #define DMA1_STREAM2_SxFCR REG32(DMA1_BASE + DMA_STREAM2_OFFSET + DMA_SxFCR_OFFSET)
        #define DMA1_STREAM3_SxCR REG32(DMA1_BASE + DMA_STREAM3_OFFSET + DMA_SxCR_OFFSET)
        #define DMA1_STREAM3_SxNDTR REG32(DMA1_BASE + DMA_STREAM3_OFFSET + DMA_SxNDTR_OFFSET)
        #define DMA1_STREAM3_SxPAR REG32(DMA1_BASE + DMA_STREAM3_OFFSET + DMA_SxPAR_OFFSET)
        #define DMA1_STREAM3_SxM0AR REG32(DMA1_BASE + DMA_STREAM3_OFFSET + DMA_SxM0AR_OFFSET)
        #define DMA1_STREAM3_SxM1AR REG32(DMA1_BASE + DMA_STREAM3_OFFSET + DMA_SxM1AR_OFFSET)
        #define DMA1_STREAM3_SxFCR REG32(DMA1_BASE + DMA_STREAM3_OFFSET + DMA_SxFCR_OFFSET)
        #define DMA1_STREAM4_SxCR REG32(DMA1_BASE + DMA_STREAM4_OFFSET + DMA_SxCR_OFFSET)
        #define DMA1_STREAM4_SxNDTR REG32(DMA1_BASE + DMA_STREAM4_OFFSET + DMA_SxNDTR_OFFSET)
        #define DMA1_STREAM4_SxPAR REG32(DMA1_BASE + DMA_STREAM4_OFFSET + DMA_SxPAR_OFFSET)
        #define DMA1_STREAM4_SxM0AR REG32(DMA1_BASE + DMA_STREAM4_OFFSET + DMA_SxM0AR_OFFSET)
        #define DMA1_STREAM4_SxM1AR REG32(DMA1_BASE + DMA_STREAM4_OFFSET + DMA_SxM1AR_OFFSET)
        #define DMA1_STREAM4_SxFCR REG32(DMA1_BASE + DMA_STREAM4_OFFSET + DMA_SxFCR_OFFSET)
        #define DMA1_STREAM5_SxCR REG32(DMA1_BASE + DMA_STREAM5_OFFSET + DMA_SxCR_OFFSET)
        #define DMA1_STREAM5_SxNDTR REG32(DMA1_BASE + DMA_STREAM5_OFFSET + DMA_SxNDTR_OFFSET)
        #define DMA1_STREAM5_SxPAR REG32(DMA1_BASE + DMA_STREAM5_OFFSET + DMA_SxPAR_OFFSET)
        #define DMA1_STREAM5_SxM0AR REG32(DMA1_BASE + DMA_STREAM5_OFFSET + DMA_SxM0AR_OFFSET)
        #define DMA1_STREAM5_SxM1AR REG32(DMA1_BASE + DMA_STREAM5_OFFSET + DMA_SxM1AR_OFFSET)
        #define DMA1_STREAM5_SxFCR REG32(DMA1_BASE + DMA_STREAM5_OFFSET + DMA_SxFCR_OFFSET)
        #define DMA1_STREAM6_SxCR REG32(DMA1_BASE + DMA_STREAM6_OFFSET + DMA_SxCR_OFFSET)
        #define DMA1_STREAM6_SxNDTR REG32(DMA1_BASE + DMA_STREAM6_OFFSET + DMA_SxNDTR_OFFSET)
        #define DMA1_STREAM6_SxPAR REG32(DMA1_BASE + DMA_STREAM6_OFFSET + DMA_SxPAR_OFFSET)
        #define DMA1_STREAM6_SxM0AR REG32(DMA1_BASE + DMA_STREAM6_OFFSET + DMA_SxM0AR_OFFSET)
        #define DMA1_STREAM6_SxM1AR REG32(DMA1_BASE + DMA_STREAM6_OFFSET + DMA_SxM1AR_OFFSET)
        #define DMA1_STREAM6_SxFCR REG32(DMA1_BASE + DMA_STREAM6_OFFSET + DMA_SxFCR_OFFSET)
        #define DMA1_STREAM7_SxCR REG32(DMA1_BASE + DMA_STREAM7_OFFSET + DMA_SxCR_OFFSET)
        #define DMA1_STREAM7_SxNDTR REG32(DMA1_BASE + DMA_STREAM7_OFFSET + DMA_SxNDTR_OFFSET)
        #define DMA1_STREAM7_SxPAR REG32(DMA1_BASE + DMA_STREAM7_OFFSET + DMA_SxPAR_OFFSET)
        #define DMA1_STREAM7_SxM0AR REG32(DMA1_BASE + DMA_STREAM7_OFFSET + DMA_SxM0AR_OFFSET)
        #define DMA1_STREAM7_SxM1AR REG32(DMA1_BASE + DMA_STREAM7_OFFSET + DMA_SxM1AR_OFFSET)
        #define DMA1_STREAM7_SxFCR REG32(DMA1_BASE + DMA_STREAM7_OFFSET + DMA_SxFCR_OFFSET)
    ...
    #define DMA2_HIFCR REG32(DMA2_BASE + DMA_HIFCR_OFFSET)
        #define DMA2_STREAM0_SxCR REG32(DMA2_BASE + DMA_STREAM0_OFFSET + DMA_SxCR_OFFSET)
        #define DMA2_STREAM0_SxNDTR REG32(DMA2_BASE + DMA_STREAM0_OFFSET + DMA_SxNDTR_OFFSET)
        #define DMA2_STREAM0_SxPAR REG32(DMA2_BASE + DMA_STREAM0_OFFSET + DMA_SxPAR_OFFSET)
        #define DMA2_STREAM0_SxM0AR REG32(DMA2_BASE + DMA_STREAM0_OFFSET + DMA_SxM0AR_OFFSET)
        #define DMA2_STREAM0_SxM1AR REG32(DMA2_BASE + DMA_STREAM0_OFFSET + DMA_SxM1AR_OFFSET)
        #define DMA2_STREAM0_SxFCR REG32(DMA2_BASE + DMA_STREAM0_OFFSET + DMA_SxFCR_OFFSET)
        #define DMA2_STREAM1_SxCR REG32(DMA2_BASE + DMA_STREAM1_OFFSET + DMA_SxCR_OFFSET)
        #define DMA2_STREAM1_SxNDTR REG32(DMA2_BASE + DMA_STREAM1_OFFSET + DMA_SxNDTR_OFFSET)
        #define DMA2_STREAM1_SxPAR REG32(DMA2_BASE + DMA_STREAM1_OFFSET + DMA_SxPAR_OFFSET)
        #define DMA2_STREAM1_SxM0AR REG32(DMA2_BASE + DMA_STREAM1_OFFSET + DMA_SxM0AR_OFFSET)
        #define DMA2_STREAM1_SxM1AR REG32(DMA2_BASE + DMA_STREAM1_OFFSET + DMA_SxM1AR_OFFSET)
        #define DMA2_STREAM1_SxFCR REG32(DMA2_BASE + DMA_STREAM1_OFFSET + DMA_SxFCR_OFFSET)
        #define DMA2_STREAM2_SxCR REG32(DMA2_BASE + DMA_STREAM2_OFFSET + DMA_SxCR_OFFSET)
        #define DMA2_STREAM2_SxNDTR REG32(DMA2_BASE + DMA_STREAM2_OFFSET + DMA_SxNDTR_OFFSET)
        #define DMA2_STREAM2_SxPAR REG32(DMA2_BASE + DMA_STREAM2_OFFSET + DMA_SxPAR_OFFSET)
        #define DMA2_STREAM2_SxM0AR REG32(DMA2_BASE + DMA_STREAM2_OFFSET + DMA_SxM0AR_OFFSET)
        #define DMA2_STREAM2_SxM1AR REG32(DMA2_BASE + DMA_STREAM2_OFFSET + DMA_SxM1AR_OFFSET)
        #define DMA2_STREAM2_SxFCR REG32(DMA2_BASE + DMA_STREAM2_OFFSET + DMA_SxFCR_OFFSET)
        #define DMA2_STREAM3_SxCR REG32(DMA2_BASE + DMA_STREAM3_OFFSET + DMA_SxCR_OFFSET)
        #define DMA2_STREAM3_SxNDTR REG32(DMA2_BASE + DMA_STREAM3_OFFSET + DMA_SxNDTR_OFFSET)
        #define DMA2_STREAM3_SxPAR REG32(DMA2_BASE + DMA_STREAM3_OFFSET + DMA_SxPAR_OFFSET)
        #define DMA2_STREAM3_SxM0AR REG32(DMA2_BASE + DMA_STREAM3_OFFSET + DMA_SxM0AR_OFFSET)
        #define DMA2_STREAM3_SxM1AR REG32(DMA2_BASE + DMA_STREAM3_OFFSET + DMA_SxM1AR_OFFSET)
        #define DMA2_STREAM3_SxFCR REG32(DMA2_BASE + DMA_STREAM3_OFFSET + DMA_SxFCR_OFFSET)
        #define DMA2_STREAM4_SxCR REG32(DMA2_BASE + DMA_STREAM4_OFFSET + DMA_SxCR_OFFSET)
        #define DMA2_STREAM4_SxNDTR REG32(DMA2_BASE + DMA_STREAM4_OFFSET + DMA_SxNDTR_OFFSET)
        #define DMA2_STREAM4_SxPAR REG32(DMA2_BASE + DMA_STREAM4_OFFSET + DMA_SxPAR_OFFSET)
        #define DMA2_STREAM4_SxM0AR REG32(DMA2_BASE + DMA_STREAM4_OFFSET + DMA_SxM0AR_OFFSET)
        #define DMA2_STREAM4_SxM1AR REG32(DMA2_BASE + DMA_STREAM4_OFFSET + DMA_SxM1AR_OFFSET)
        #define DMA2_STREAM4_SxFCR REG32(DMA2_BASE + DMA_STREAM4_OFFSET + DMA_SxFCR_OFFSET)
        #define DMA2_STREAM5_SxCR REG32(DMA2_BASE + DMA_STREAM5_OFFSET + DMA_SxCR_OFFSET)
        #define DMA2_STREAM5_SxNDTR REG32(DMA2_BASE + DMA_STREAM5_OFFSET + DMA_SxNDTR_OFFSET)
        #define DMA2_STREAM5_SxPAR REG32(DMA2_BASE + DMA_STREAM5_OFFSET + DMA_SxPAR_OFFSET)
        #define DMA2_STREAM5_SxM0AR REG32(DMA2_BASE + DMA_STREAM5_OFFSET + DMA_SxM0AR_OFFSET)
        #define DMA2_STREAM5_SxM1AR REG32(DMA2_BASE + DMA_STREAM5_OFFSET + DMA_SxM1AR_OFFSET)
        #define DMA2_STREAM5_SxFCR REG32(DMA2_BASE + DMA_STREAM5_OFFSET + DMA_SxFCR_OFFSET)
        #define DMA2_STREAM6_SxCR REG32(DMA2_BASE + DMA_STREAM6_OFFSET + DMA_SxCR_OFFSET)
        #define DMA2_STREAM6_SxNDTR REG32(DMA2_BASE + DMA_STREAM6_OFFSET + DMA_SxNDTR_OFFSET)
        #define DMA2_STREAM6_SxPAR REG32(DMA2_BASE + DMA_STREAM6_OFFSET + DMA_SxPAR_OFFSET)
        #define DMA2_STREAM6_SxM0AR REG32(DMA2_BASE + DMA_STREAM6_OFFSET + DMA_SxM0AR_OFFSET)
        #define DMA2_STREAM6_SxM1AR REG32(DMA2_BASE + DMA_STREAM6_OFFSET + DMA_SxM1AR_OFFSET)
        #define DMA2_STREAM6_SxFCR REG32(DMA2_BASE + DMA_STREAM6_OFFSET + DMA_SxFCR_OFFSET)
        #define DMA2_STREAM7_SxCR REG32(DMA2_BASE + DMA_STREAM7_OFFSET + DMA_SxCR_OFFSET)
        #define DMA2_STREAM7_SxNDTR REG32(DMA2_BASE + DMA_STREAM7_OFFSET + DMA_SxNDTR_OFFSET)
        #define DMA2_STREAM7_SxPAR REG32(DMA2_BASE + DMA_STREAM7_OFFSET + DMA_SxPAR_OFFSET)
        #define DMA2_STREAM7_SxM0AR REG32(DMA2_BASE + DMA_STREAM7_OFFSET + DMA_SxM0AR_OFFSET)
        #define DMA2_STREAM7_SxM1AR REG32(DMA2_BASE + DMA_STREAM7_OFFSET + DMA_SxM1AR_OFFSET)
        #define DMA2_STREAM7_SxFCR REG32(DMA2_BASE + DMA_STREAM7_OFFSET + DMA_SxFCR_OFFSET) 
