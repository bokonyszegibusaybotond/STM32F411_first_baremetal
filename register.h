...
/*----TIMER peripherals register definiton-----*/
   ...
   #define TIM11_BASE 0x40014800
    ...
    #define NVIC_ISRx_BASE 0xE000E000
            ...
            #define NVIC_ISER2_OFFSET 0x108
            #define NVIC_ISER3_OFFSET 0x10C
            #define NVIC_ISER4_OFFSET 0x110
            #define NVIC_ISER5_OFFSET 0x114
            #define NVIC_ISER6_OFFSET 0x118
            #define NVIC_ISER7_OFFSET 0x11C           
        ...
        #define NVIC_ISER0 REG32(NVIC_ISRx_BASE + NVIC_ISER0_OFFSET)
        #define NVIC_ISER1 REG32(NVIC_ISRx_BASE + NVIC_ISER1_OFFSET)
        #define NVIC_ISER2 REG32(NVIC_ISRx_BASE + NVIC_ISER2_OFFSET)
        #define NVIC_ISER3 REG32(NVIC_ISRx_BASE + NVIC_ISER3_OFFSET)
        #define NVIC_ISER4 REG32(NVIC_ISRx_BASE + NVIC_ISER4_OFFSET)
        #define NVIC_ISER5 REG32(NVIC_ISRx_BASE + NVIC_ISER5_OFFSET)
        #define NVIC_ISER6 REG32(NVIC_ISRx_BASE + NVIC_ISER6_OFFSET)
        #define NVIC_ISER7 REG32(NVIC_ISRx_BASE + NVIC_ISER7_OFFSET)
...
/*-----USART register definition-----*/
    //base adress of USART peripherals
    ...
    //USART1
    #define USART1_SR REG32(USART1_BASE + USARTx_SR_OFFSET)
    #define USART1_DR REG32(USART1_BASE + USARTx_DR_OFFSET)
    #define USART1_BRR REG32(USART1_BASE + USARTx_BRR_OFFSET)
    #define USART1_CR1 REG32(USART1_BASE + USARTx_CR1_OFFSET)
    #define USART1_CR2 REG32(USART1_BASE + USARTx_CR2_OFFSET)
    #define USART1_CR3 REG32(USART1_BASE + USARTx_CR3_OFFSET)
    #define USART1_GTPR REG32(USART1_BASE + USARTx_GTPR_OFFSET)

    //USART2
    #define USART2_SR REG32(USART2_BASE + USARTx_SR_OFFSET)
    #define USART2_DR REG32(USART2_BASE + USARTx_DR_OFFSET)
    #define USART2_BRR REG32(USART2_BASE + USARTx_BRR_OFFSET)
    #define USART2_CR1 REG32(USART2_BASE + USARTx_CR1_OFFSET)
    #define USART2_CR2 REG32(USART2_BASE + USARTx_CR2_OFFSET)
    #define USART2_CR3 REG32(USART2_BASE + USARTx_CR3_OFFSET)
    #define USART2_GTPR REG32(USART2_BASE + USARTx_GTPR_OFFSET)

    //USART6
    #define USART6_SR REG32(USART6_BASE + USARTx_SR_OFFSET)
    #define USART6_DR REG32(USART6_BASE + USARTx_DR_OFFSET)
    #define USART6_BRR REG32(USART6_BASE + USARTx_BRR_OFFSET)
    #define USART6_CR1 REG32(USART6_BASE + USARTx_CR1_OFFSET)
    #define USART6_CR2 REG32(USART6_BASE + USARTx_CR2_OFFSET)
    #define USART6_CR3 REG32(USART6_BASE + USARTx_CR3_OFFSET)
    #define USART6_GTPR REG32(USART6_BASE + USARTx_GTPR_OFFSET)
    ...
    #define SYSCFG_PMC REG32(SYSCFG_BASE + SYSCFG_PMC_OFFSET)
    #define SYSCFG_EXTICR1 REG32(SYSCFG_BASE + SYSCFG_EXTICR1_OFFSET)
    #define SYSCFG_EXTICR2 REG32(SYSCFG_BASE + SYSCFG_EXTICR2_OFFSET)
    #define SYSCFG_EXTICR3 REG32(SYSCFG_BASE + SYSCFG_EXTICR3_OFFSET)
    #define SYSCFG_EXTICR4 REG32(SYSCFG_BASE + SYSCFG_EXTICR4_OFFSET)
    #define SYSCFG_CMPCR REG32(SYSCFG_BASE + SYSCFG_CMPCR_OFFSET)
    ...
    #define EXTI_IMR REG32(EXTI_BASE + EXTI_IMR_OFFSET)
    #define EXTI_EMR REG32(EXTI_BASE + EXTI_EMR_OFFSET)
    #define EXTI_RTSR REG32(EXTI_BASE + EXTI_RTSR_OFFSET)
    #define EXTI_FTSR REG32(EXTI_BASE + EXTI_FTSR_OFFSET)
    #define EXTI_SWIER REG32(EXTI_BASE + EXTI_SWIER_OFFSET)
    #define EXTI_PR REG32(EXTI_BASE + EXTI_PR_OFFSET)


    /*-----DMA register definition-----*/
    #define DMA1_BASE 0x40026000
    #define DMA2_BASE 0x40026400
        #define DMA_LISR_OFFSET 0x00 // low adress interupt status register (streams 0-3)
        #define DMA_HISR_OFFSET 0x04 // high adress interrupt status register (streams 4-7)
        #define DMA_LIFCR_OFFSET 0x08 // low adress control register
        #define DMA_HIFCR_OFFSET 0x0C // low adress control register
            #define DMA_STREAM0_OFFSET 0x10
            #define DMA_STREAM1_OFFSET 0x28
            #define DMA_STREAM2_OFFSET 0x40
            #define DMA_STREAM3_OFFSET 0x58
            #define DMA_STREAM4_OFFSET 0x70
            #define DMA_STREAM5_OFFSET 0x88
            #define DMA_STREAM6_OFFSET 0xA0
            #define DMA_STREAM7_OFFSET 0xB8
                #define DMA_SxCR_OFFSET 0x00 // control register
                #define DMA_SxNDTR_OFFSET 0x04 // number of data to transfer
                #define DMA_SxPAR_OFFSET 0x08 // peripheral adress register
                #define DMA_SxM0AR_OFFSET 0x0C // memory adress 0 register
                #define DMA_SxM1AR_OFFSET 0x10 // memory adress 1 register
                #define DMA_SxFCR_OFFSET 0x14 // FIFO control register

    #define DMA1_LISR REG32(DMA1_BASE + DMA_LISR_OFFSET)
    #define DMA1_HISR REG32(DMA1_BASE + DMA_HISR_OFFSET)
    #define DMA1_LIFCR REG32(DMA1_BASE + DMA_LIFCR_OFFSET)
    #define DMA1_HIFCR REG32(DMA1_BASE + DMA_HIFCR_OFFSET)
        #define DMA1_S0CR REG32(DMA1_BASE + DMA_STREAM0_OFFSET + DMA_SxCR_OFFSET)
        #define DMA1_S0NDTR REG32(DMA1_BASE + DMA_STREAM0_OFFSET + DMA_SxNDTR_OFFSET)
        #define DMA1_S0PAR REG32(DMA1_BASE + DMA_STREAM0_OFFSET + DMA_SxPAR_OFFSET)
        #define DMA1_S0M0AR REG32(DMA1_BASE + DMA_STREAM0_OFFSET + DMA_SxM0AR_OFFSET)
        #define DMA1_S0M1AR REG32(DMA1_BASE + DMA_STREAM0_OFFSET + DMA_SxM1AR_OFFSET)
        #define DMA1_S0xFCR REG32(DMA1_BASE + DMA_STREAM0_OFFSET + DMA_SxFCR_OFFSET)
        #define DMA1_S1CR REG32(DMA1_BASE + DMA_STREAM1_OFFSET + DMA_SxCR_OFFSET)
        #define DMA1_S1NDTR REG32(DMA1_BASE + DMA_STREAM1_OFFSET + DMA_SxNDTR_OFFSET)
        #define DMA1_S1PAR REG32(DMA1_BASE + DMA_STREAM1_OFFSET + DMA_SxPAR_OFFSET)
        #define DMA1_S1M0AR REG32(DMA1_BASE + DMA_STREAM1_OFFSET + DMA_SxM0AR_OFFSET)
        #define DMA1_S1M1AR REG32(DMA1_BASE + DMA_STREAM1_OFFSET + DMA_SxM1AR_OFFSET)
        #define DMA1_S1xFCR REG32(DMA1_BASE + DMA_STREAM1_OFFSET + DMA_SxFCR_OFFSET)
        #define DMA1_S2CR REG32(DMA1_BASE + DMA_STREAM2_OFFSET + DMA_SxCR_OFFSET)
        #define DMA1_S2NDTR REG32(DMA1_BASE + DMA_STREAM2_OFFSET + DMA_SxNDTR_OFFSET)
        #define DMA1_S2PAR REG32(DMA1_BASE + DMA_STREAM2_OFFSET + DMA_SxPAR_OFFSET)
        #define DMA1_S2M0AR REG32(DMA1_BASE + DMA_STREAM2_OFFSET + DMA_SxM0AR_OFFSET)
        #define DMA1_S2M1AR REG32(DMA1_BASE + DMA_STREAM2_OFFSET + DMA_SxM1AR_OFFSET)
        #define DMA1_S2xFCR REG32(DMA1_BASE + DMA_STREAM2_OFFSET + DMA_SxFCR_OFFSET)
        #define DMA1_S3CR REG32(DMA1_BASE + DMA_STREAM3_OFFSET + DMA_SxCR_OFFSET)
        #define DMA1_S3NDTR REG32(DMA1_BASE + DMA_STREAM3_OFFSET + DMA_SxNDTR_OFFSET)
        #define DMA1_S3PAR REG32(DMA1_BASE + DMA_STREAM3_OFFSET + DMA_SxPAR_OFFSET)
        #define DMA1_S3M0AR REG32(DMA1_BASE + DMA_STREAM3_OFFSET + DMA_SxM0AR_OFFSET)
        #define DMA1_S3M1AR REG32(DMA1_BASE + DMA_STREAM3_OFFSET + DMA_SxM1AR_OFFSET)
        #define DMA1_S3xFCR REG32(DMA1_BASE + DMA_STREAM3_OFFSET + DMA_SxFCR_OFFSET)
        #define DMA1_S4CR REG32(DMA1_BASE + DMA_STREAM4_OFFSET + DMA_SxCR_OFFSET)
        #define DMA1_S4NDTR REG32(DMA1_BASE + DMA_STREAM4_OFFSET + DMA_SxNDTR_OFFSET)
        #define DMA1_S4PAR REG32(DMA1_BASE + DMA_STREAM4_OFFSET + DMA_SxPAR_OFFSET)
        #define DMA1_S4M0AR REG32(DMA1_BASE + DMA_STREAM4_OFFSET + DMA_SxM0AR_OFFSET)
        #define DMA1_S4M1AR REG32(DMA1_BASE + DMA_STREAM4_OFFSET + DMA_SxM1AR_OFFSET)
        #define DMA1_S4xFCR REG32(DMA1_BASE + DMA_STREAM4_OFFSET + DMA_SxFCR_OFFSET)
        #define DMA1_S5CR REG32(DMA1_BASE + DMA_STREAM5_OFFSET + DMA_SxCR_OFFSET)
        #define DMA1_S5NDTR REG32(DMA1_BASE + DMA_STREAM5_OFFSET + DMA_SxNDTR_OFFSET)
        #define DMA1_S5PAR REG32(DMA1_BASE + DMA_STREAM5_OFFSET + DMA_SxPAR_OFFSET)
        #define DMA1_S5M0AR REG32(DMA1_BASE + DMA_STREAM5_OFFSET + DMA_SxM0AR_OFFSET)
        #define DMA1_S5M1AR REG32(DMA1_BASE + DMA_STREAM5_OFFSET + DMA_SxM1AR_OFFSET)
        #define DMA1_S5xFCR REG32(DMA1_BASE + DMA_STREAM5_OFFSET + DMA_SxFCR_OFFSET)
        #define DMA1_S6CR REG32(DMA1_BASE + DMA_STREAM6_OFFSET + DMA_SxCR_OFFSET)
        #define DMA1_S6NDTR REG32(DMA1_BASE + DMA_STREAM6_OFFSET + DMA_SxNDTR_OFFSET)
        #define DMA1_S6PAR REG32(DMA1_BASE + DMA_STREAM6_OFFSET + DMA_SxPAR_OFFSET)
        #define DMA1_S6M0AR REG32(DMA1_BASE + DMA_STREAM6_OFFSET + DMA_SxM0AR_OFFSET)
        #define DMA1_S6M1AR REG32(DMA1_BASE + DMA_STREAM6_OFFSET + DMA_SxM1AR_OFFSET)
        #define DMA1_S6xFCR REG32(DMA1_BASE + DMA_STREAM6_OFFSET + DMA_SxFCR_OFFSET)
        #define DMA1_S7CR REG32(DMA1_BASE + DMA_STREAM7_OFFSET + DMA_SxCR_OFFSET)
        #define DMA1_S7NDTR REG32(DMA1_BASE + DMA_STREAM7_OFFSET + DMA_SxNDTR_OFFSET)
        #define DMA1_S7PAR REG32(DMA1_BASE + DMA_STREAM7_OFFSET + DMA_SxPAR_OFFSET)
        #define DMA1_S7M0AR REG32(DMA1_BASE + DMA_STREAM7_OFFSET + DMA_SxM0AR_OFFSET)
        #define DMA1_S7M1AR REG32(DMA1_BASE + DMA_STREAM7_OFFSET + DMA_SxM1AR_OFFSET)
        #define DMA1_S7xFCR REG32(DMA1_BASE + DMA_STREAM7_OFFSET + DMA_SxFCR_OFFSET)

    #define DMA2_LISR REG32(DMA2_BASE + DMA_LISR_OFFSET)
    #define DMA2_HISR REG32(DMA2_BASE + DMA_HISR_OFFSET)
    #define DMA2_LIFCR REG32(DMA2_BASE + DMA_LIFCR_OFFSET)
    #define DMA2_HIFCR REG32(DMA2_BASE + DMA_HIFCR_OFFSET)
        #define DMA2_S0CR REG32(DMA2_BASE + DMA_STREAM0_OFFSET + DMA_SxCR_OFFSET)
        #define DMA2_S0NDTR REG32(DMA2_BASE + DMA_STREAM0_OFFSET + DMA_SxNDTR_OFFSET)
        #define DMA2_S0PAR REG32(DMA2_BASE + DMA_STREAM0_OFFSET + DMA_SxPAR_OFFSET)
        #define DMA2_S0M0AR REG32(DMA2_BASE + DMA_STREAM0_OFFSET + DMA_SxM0AR_OFFSET)
        #define DMA2_S0M1AR REG32(DMA2_BASE + DMA_STREAM0_OFFSET + DMA_SxM1AR_OFFSET)
        #define DMA2_S0xFCR REG32(DMA2_BASE + DMA_STREAM0_OFFSET + DMA_SxFCR_OFFSET)
        #define DMA2_S1CR REG32(DMA2_BASE + DMA_STREAM1_OFFSET + DMA_SxCR_OFFSET)
        #define DMA2_S1NDTR REG32(DMA2_BASE + DMA_STREAM1_OFFSET + DMA_SxNDTR_OFFSET)
        #define DMA2_S1PAR REG32(DMA2_BASE + DMA_STREAM1_OFFSET + DMA_SxPAR_OFFSET)
        #define DMA2_S1M0AR REG32(DMA2_BASE + DMA_STREAM1_OFFSET + DMA_SxM0AR_OFFSET)
        #define DMA2_S1M1AR REG32(DMA2_BASE + DMA_STREAM1_OFFSET + DMA_SxM1AR_OFFSET)
        #define DMA2_S1xFCR REG32(DMA2_BASE + DMA_STREAM1_OFFSET + DMA_SxFCR_OFFSET)
        #define DMA2_S2CR REG32(DMA2_BASE + DMA_STREAM2_OFFSET + DMA_SxCR_OFFSET)
        #define DMA2_S2NDTR REG32(DMA2_BASE + DMA_STREAM2_OFFSET + DMA_SxNDTR_OFFSET)
        #define DMA2_S2PAR REG32(DMA2_BASE + DMA_STREAM2_OFFSET + DMA_SxPAR_OFFSET)
        #define DMA2_S2M0AR REG32(DMA2_BASE + DMA_STREAM2_OFFSET + DMA_SxM0AR_OFFSET)
        #define DMA2_S2M1AR REG32(DMA2_BASE + DMA_STREAM2_OFFSET + DMA_SxM1AR_OFFSET)
        #define DMA2_S2xFCR REG32(DMA2_BASE + DMA_STREAM2_OFFSET + DMA_SxFCR_OFFSET)
        #define DMA2_S3CR REG32(DMA2_BASE + DMA_STREAM3_OFFSET + DMA_SxCR_OFFSET)
        #define DMA2_S3NDTR REG32(DMA2_BASE + DMA_STREAM3_OFFSET + DMA_SxNDTR_OFFSET)
        #define DMA2_S3PAR REG32(DMA2_BASE + DMA_STREAM3_OFFSET + DMA_SxPAR_OFFSET)
        #define DMA2_S3M0AR REG32(DMA2_BASE + DMA_STREAM3_OFFSET + DMA_SxM0AR_OFFSET)
        #define DMA2_S3M1AR REG32(DMA2_BASE + DMA_STREAM3_OFFSET + DMA_SxM1AR_OFFSET)
        #define DMA2_S3xFCR REG32(DMA2_BASE + DMA_STREAM3_OFFSET + DMA_SxFCR_OFFSET)
        #define DMA2_S4CR REG32(DMA2_BASE + DMA_STREAM4_OFFSET + DMA_SxCR_OFFSET)
        #define DMA2_S4NDTR REG32(DMA2_BASE + DMA_STREAM4_OFFSET + DMA_SxNDTR_OFFSET)
        #define DMA2_S4PAR REG32(DMA2_BASE + DMA_STREAM4_OFFSET + DMA_SxPAR_OFFSET)
        #define DMA2_S4M0AR REG32(DMA2_BASE + DMA_STREAM4_OFFSET + DMA_SxM0AR_OFFSET)
        #define DMA2_S4M1AR REG32(DMA2_BASE + DMA_STREAM4_OFFSET + DMA_SxM1AR_OFFSET)
        #define DMA2_S4xFCR REG32(DMA2_BASE + DMA_STREAM4_OFFSET + DMA_SxFCR_OFFSET)
        #define DMA2_S5CR REG32(DMA2_BASE + DMA_STREAM5_OFFSET + DMA_SxCR_OFFSET)
        #define DMA2_S5NDTR REG32(DMA2_BASE + DMA_STREAM5_OFFSET + DMA_SxNDTR_OFFSET)
        #define DMA2_S5PAR REG32(DMA2_BASE + DMA_STREAM5_OFFSET + DMA_SxPAR_OFFSET)
        #define DMA2_S5M0AR REG32(DMA2_BASE + DMA_STREAM5_OFFSET + DMA_SxM0AR_OFFSET)
        #define DMA2_S5M1AR REG32(DMA2_BASE + DMA_STREAM5_OFFSET + DMA_SxM1AR_OFFSET)
        #define DMA2_S5xFCR REG32(DMA2_BASE + DMA_STREAM5_OFFSET + DMA_SxFCR_OFFSET)
        #define DMA2_S6CR REG32(DMA2_BASE + DMA_STREAM6_OFFSET + DMA_SxCR_OFFSET)
        #define DMA2_S6NDTR REG32(DMA2_BASE + DMA_STREAM6_OFFSET + DMA_SxNDTR_OFFSET)
        #define DMA2_S6PAR REG32(DMA2_BASE + DMA_STREAM6_OFFSET + DMA_SxPAR_OFFSET)
        #define DMA2_S6M0AR REG32(DMA2_BASE + DMA_STREAM6_OFFSET + DMA_SxM0AR_OFFSET)
        #define DMA2_S6M1AR REG32(DMA2_BASE + DMA_STREAM6_OFFSET + DMA_SxM1AR_OFFSET)
        #define DMA2_S6xFCR REG32(DMA2_BASE + DMA_STREAM6_OFFSET + DMA_SxFCR_OFFSET)
        #define DMA2_S7CR REG32(DMA2_BASE + DMA_STREAM7_OFFSET + DMA_SxCR_OFFSET)
        #define DMA2_S7NDTR REG32(DMA2_BASE + DMA_STREAM7_OFFSET + DMA_SxNDTR_OFFSET)
        #define DMA2_S7PAR REG32(DMA2_BASE + DMA_STREAM7_OFFSET + DMA_SxPAR_OFFSET)
        #define DMA2_S7M0AR REG32(DMA2_BASE + DMA_STREAM7_OFFSET + DMA_SxM0AR_OFFSET)
        #define DMA2_S7M1AR REG32(DMA2_BASE + DMA_STREAM7_OFFSET + DMA_SxM1AR_OFFSET)
        #define DMA2_S7xFCR REG32(DMA2_BASE + DMA_STREAM7_OFFSET + DMA_SxFCR_OFFSET) 
